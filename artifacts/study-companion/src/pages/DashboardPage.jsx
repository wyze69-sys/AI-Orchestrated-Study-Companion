...
function DashboardPage() {
    ...
    /* Page title */
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent aria-describedby={void 0}>
              <DialogHeader>
  ...
  >
    ...
    /* Stats row */
        ...
        {dashboard.data && <div className="grid grid-cols-3 gap-4 mb-8">
            {[
  ...
  ].map(({ label, value, icon: Icon }) => <Card key={label} className="border-card-border">
